      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 gap-3 ${className}`}>
        ...
        <button
          ...
          className={`flex items-center justify-between p-3.5 rounded-xl border text-start transition-all cursor-pointer ${
            language === 'en'
              ? 'bg-blue-600/15 border-blue-500/50 text-slate-900 dark:text-white shadow-sm ring-1 ring-blue-500/30'
        ...
        >
          ...
          <div className={`w-4 h-4 rounded-full border flex items-center justify-center transition-all ${
            language === 'en' ? 'border-blue-500 bg-blue-500 text-white' : 'border-slate-400 dark:border-slate-600'
          }`}>
        ...
        >
          ...
          <div className={`w-4 h-4 rounded-full border flex items-center justify-center transition-all ${
            language === 'ar' ? 'border-emerald-500 bg-emerald-500 text-white' : 'border-slate-400 dark:border-slate-600'
          }`}>
